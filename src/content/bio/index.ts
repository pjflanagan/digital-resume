...
const PageBio = {
      ...
      links: [
        {
          ...
          callbackParam: [{ action: 'image', param: 'personal-roller-blade.jpg' }],
          text: 'rollerblader',
        },
        {
          key: 'rockclimber',
          callbackParam: [{ action: 'image', param: 'personal-rock-climbing.jpg' }],
          text: 'rock climber',
        },
        {
          key: 'scuba',
          callbackParam: [{ action: 'image', param: 'personal-scuba.jpg' }],
          text: 'SCUBA diver',
        },
        {
        ...
        {
          key: 'board_sport',
          callbackParam: [{ action: 'image', param: 'personal-snowboarding.jpg' }],
          text: 'board sport',
        },
      ],
      text: [
  ...
  contact: {
    accent: "Let's make",
    title: 'Contact!',
    text: "While I'm not seeking new opportunities right now, feel free to reach out and I'll be sure to phone back!",
    links: [
      {
        icon: 'email',
